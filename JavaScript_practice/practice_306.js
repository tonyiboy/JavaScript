...
// You are given a function that takes a parameter age (which will always be a positive integer) 
...
// submitting the given code will not work because there is a character limit of 137.
...
let describeAge = age => "You're a(n) " + (age <= 12 ? "kid" : age >= 13 && age <= 17 ? "teenager" : age >= 18 && age <= 64 ? "adult" : "elderly")