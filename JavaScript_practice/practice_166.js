...
// The Task
// Think of a way to store the languages as a database. The languages are listed below so you 
// can copy and paste!
// Write a 'welcome' function that takes a parameter 'language', with a type String, and returns 
// a greeting - if you have it in your database. It should default to English if the language is 
...
let myDatabase = [
  ...
  for (let i = 0; i < myDatabase.length; i++) {
    if(myDatabase[i][0] === language) { 
      return myDatabase[i][1]
  } 
  }
