...
console.log(backgroundColor.nextSibling);
console.log(backgroundColor.previousSibling);

console.log(backgroundColor.nextElementSibling);
console.log(backgroundColor.previousElementSibling);
