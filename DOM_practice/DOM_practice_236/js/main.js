...
console.log(fontSize.previousSibling);
console.log(fontSize.nextSibling);

console.log(fontSize.previousElementSibling);
console.log(fontSize.nextElementSibling);
